...
class PyFunction(FunctionObject):
    ...
    def __init__(self):
        ...
        self.id = 'FC_ASGN_PT_CD'
        self.country = 'CHN'
        self.desc = '赋值考勤项目函数'
        self.descENG = '赋值考勤项目函数'
        self.func_type = 'B'
        self.instructions = "赋值考勤项目函数。"
        ...
        if log_flag == 'Y':
            self.trace_dic = {
                ...
                'WT': [],
                'VR': [],
                'PA': ['pt_code', 'pt_date', 'quantity', 'unit']
            }
        else:
            self.trace_dic = {}

    @log()
    def func_exec(self, pt_code, pt_date, quantity, unit):
        ...
        if vr_cal_ptpy == 'Y':
            ...
            pt_process_obj.assign_pt_cd(pt_code, pt_date, quantity, unit)
        else:
            pass
